...
public interface OtpRepository extends JpaRepository<OtpEntity,Long> {
    @Query(value = """
          ...
          where o.user.id = :id and (o.expiredTime >= CURRENT_TIMESTAMP and o.revoked = false and o.otpType =:otpType)
    ...
    @Query(value = """
          ...
          (o.expiredTime >= CURRENT_TIMESTAMP and o.revoked = false and o.otpType =:otpType and o.otp=:otp)
    """)
    Optional<OtpEntity> findValidOtpByUser(String email, String otp, OtpType otpType);
    @Query(value = """
          select o from OtpEntity o  where o.user.id = :id and 
          (o.expiredTime >= CURRENT_TIMESTAMP and o.revoked = false and o.otpType =:otpType and o.otp=:otp)
    """)
    Optional<OtpEntity> findValidOtpByUserID(Long id, String otp, OtpType otpType);
