...
public class EventServiceImpl implements IEventService {
    ...
    @Override
    public ResponseEntity<ResponseObject> updateEvent(EventDTO request, Authentication authentication) {
        UserAccountEntity userAccountEntity = userAccountRetriever.getUserAccountEntityFromAuthentication(authentication);
        Optional<EventEntity> event = eventRepository.findById(request.getId());
        if (event.isPresent()) {
